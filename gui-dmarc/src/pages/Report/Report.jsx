                                ...
                                <table className="flex-row divide-y border bg-gray-700">
                                    <thead className="">
                                        <tr>
                                            ...
                                            <td className="border px-4 py-2">{report.policy_published.domain}</td>
                                        </tr>
                                        <tr>
                                            <th className="px-4 py-2 border">adkim</th>
                                            <td className="border px-4 py-2">{report.policy_published.adkim}</td>
                                        </tr>
                                        <tr>
                                            <th className="px-4 py-2 border">aspf</th>
                                            <td className="border px-4 py-2">{report.policy_published.aspf}</td>
                                        </tr>
                                        <tr>
                                            <th className="px-4 py-2 border">o</th>
                                            <td className="border px-4 py-2">{report.policy_published.p}</td>
                                        </tr>
                                        <tr>
                                            <th className="px-4 py-2 border">sp</th>
                                            <td className="border px-4 py-2">{report.policy_published.sp}</td>
                                        </tr>
                                        <tr>
                                            <th className="px-4 py-2 border">pct</th>
                                            <td className="border px-4 py-2">{report.policy_published.pct}</td>
                                        </tr>
                                        <tr>
                                            <th className="px-4 py-2 border">fo</th>
                                            <td className="border px-4 py-2">{report.policy_published.fo}</td>
                                        </tr>
                                    </thead>
                                </table>
